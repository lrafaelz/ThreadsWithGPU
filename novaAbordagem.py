...
def executar_operacoes_arquivo(matriz):
    ...
    resposta = np.concatenate((matriz_ordenada_linha,
                               ...
                               soma_linhas.reshape(1, -1),
                               soma_colunas.reshape(1, -1),
                               np.array([[soma_total]]),
                               maiores_linha.reshape(1, -1),
                               maiores_coluna.reshape(1, -1),
                               menores_linha.reshape(1, -1),
                               menores_coluna.reshape(1, -1)), axis=0)
